...
namespace RestaurantAPI.IntegrationTests.Validators
{
    public class RestaurantQueryValidatorTests
    {
        ...
        public void Validate_For_CorrectModel_ReturnsSuccess(RestaurantQuery model)
        {
            // arrange
        ...
        public void Validate_For_IncorrectModel_ReturnsFailure(RestaurantQuery model)
        {
            // arrange
            var validator = new RestaurantQueryValidator();
